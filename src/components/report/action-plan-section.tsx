...
import { ActionPlanStep } from "@/types/verdict";
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-6 sm:p-7 shadow-sm space-y-6">
        <div className="flex items-center justify-between flex-wrap gap-2 pb-3 border-b border-slate-100">
          <div className="space-y-0.5">
            ...
            <p className="text-xs text-slate-600">
              Practical execution roadmap generated by backend intelligence to convert this advisory into an operating enterprise.
            </p>
          </div>
        ...
        {steps.length === 0 ? (
          ...
          <div className="space-y-3 relative">
            {steps.map((step, idx) => {
              const stepNumber = step.stepNumber ?? step.step ?? idx + 1;
              const duration = step.duration || step.durationWeeks;
                  ...
                  <div className="flex-1 space-y-1.5">
                    ...
                    {step.responsibleEntity && (
                      <div className="pt-1 flex items-center gap-1.5 text-[11px] text-slate-500">
                        ...
                        <span className="font-semibold text-slate-700">{step.responsibleEntity}</span>
                      </div>
                    )}
                  </div>
                </div>
